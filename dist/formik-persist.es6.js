...
var index$1 = function exportedEqual(a, b) {
  try {
    return equal(a, b);
  } catch (error) {
...
var PersistImpl = (function (_super) {
    ...
    PersistImpl.prototype.componentDidUpdate = function (prevProps) {
        if (!index$1(prevProps.formik, this.context.formik)) {
            this.saveForm(prevProps.formik);
        }
    };
    PersistImpl.prototype.componentDidMount = function () {
        var maybeState = window.sessionStorage.getItem(this.props.name);
...
var Persist = connect(PersistImpl);

export { Persist };
//# sourceMappingURL=formik-persist.es6.js.map
